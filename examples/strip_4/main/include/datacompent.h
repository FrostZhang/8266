...
cJSON *begin_write_data_bdjs();
void add_write_data_bdjs(cJSON *reporter, const char *key, int number);
void add_write_data_bdjs_s(cJSON *reporter, const char *key, const char *value);
char *end_write_data_bdjs();
#endif
